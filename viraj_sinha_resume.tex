...
%		\item Working with Team Loop, building a contextual SDK for mobile applications
		\item Engineer on Loop, the team behind Arrow and Next (more info soon!)
%		\item Built and maintained large scale cluster infrastructure using Mesos, Marathon, Docker / node.js microservices
		\end{itemize}
...
\section{SKILLS} 
	...
	{\bf Tools:} Linux/UNIX/OSX, Mesos/DCOS, Docker, Biology/Biochem wet lab experience.
